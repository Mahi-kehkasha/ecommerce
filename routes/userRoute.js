...
user_route.get("/cart", auth.isLogin, userController.viewCartItems);
// user_route.post('/add-to-cart/:id', userController.addToCart);
...
user_route.get('/latest-arrivals/:days', userController.getLatestArrivals);
...
user_route.get('/proceed-to-checkout',userController.loadCheckout)

user_route.get('/my-account',auth.isLogin,userController.myAccount)
// user_route.post('/my-account',userController.saveAddress)
...
user_route.post(
 ...
 user_route.post("/update-address/:addressId",auth.isLogin,userController.updateAddress);

 user_route.delete("/delete-address/:addressId",auth.isLogin,userController.deleteAddress);

 user_route.get("/view-orders",auth.isLogin,userController.viewOrders);

 user_route.post("/update-order-status",auth.isLogin,userController.updateOrderStatus);

 user_route.post("/delete-item", auth.isLogin, userController.deleteCartItem);


user_route.get('/products',auth.isLogin, userController.filterProducts);

user_route.post('/update-personal-details',auth.isLogin, userController.updatePersonalDetails);


user_route.post('/update-password',auth.isLogin, userController.updatePassword);
...
user_route.get("/wishlist",auth.isLogin,userController.viewWishlistItems);
